...
@pytest.fixture
def mask_amount_number_test_1():
    return [{}]


@pytest.fixture
def mask_amount_number_test_2():
    return [{}]
...
@pytest.fixture
def result_transfer_date_1():
    return [{}]


@pytest.fixture
def result_transfer_date_2():
    return []
